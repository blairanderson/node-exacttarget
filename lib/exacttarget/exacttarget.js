...
ExactTarget.prototype.subscribersEvents = function(opts, callback){
  var self = this;
  async.map(events, function(event, next){
    return self[event]({}, next);
...
// http://help.exacttarget.com/en/technical_library/web_service_guide/objects/deliveredevent/
ExactTarget.prototype.DeliveredEvent = function (opts, callback) {
  return this.retrieve({
    RetrieveRequest: {
      ObjectType: "DeliveredEvent",
      "Properties": [
        "BatchID",
        "Client",
        "CorrelationID",
